...
const more_pages = document.getElementById('nav');
...
function showpages(){
     more_pages.classList.toggle('disactivate_pages');
...
function giveQuote(){
     ...
     //console.log(q);
     q.innerHTML = "Цитата: " + quotes[Math.floor(Math.random()*quotes.length)];
